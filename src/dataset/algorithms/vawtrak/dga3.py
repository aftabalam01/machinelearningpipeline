...
def generate_domains(count=96):
    domains=[]
    for seed in ['DEADBEEF','0x5542b2','0x5884c3c4','874c49', '3cdca1']:
        domains += dga(int(seed,16),count)
    return domains

if __name__=="__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("-s", "--seed", choices = {'874c49', '3cdca1'},
            default=0x874c49, help="seed value")
